// Structured-interview criteria modeled on the publicly known competency
// frameworks used by EY (Building a Better Working World competencies) and
// McKinsey (Personal Experience Interview + Problem Solving). Each criterion
// is scored 1-5 by a panelist, with supporting evidence/notes, alongside an
...
export const RATING_SCALE: RatingDescriptor[] = [
...
export const INTERVIEW_CRITERIA: Record<"ey" | "mckinsey", InterviewCriterion[]> = {
  ey: [
    {
...
export const PANEL_DECISION_LABELS: Record<string, string> = {
  pending: "Pending",
...
export const PANEL_DECISION_DESCRIPTIONS: Record<string, string> = {
